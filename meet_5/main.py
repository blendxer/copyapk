...
# remove always sunday
# change backslash to fowordslash
# remove print
# uncomment jnius 
...
save_image_path =r'C:\Users\abdul\Desktop\tex\texture\tbk.jpg'
save_thumb = r'C:\Users\abdul\Desktop\tex\texture\ttn.png'
changed_background =r'C:\Users\abdul\Desktop\tex\texture\cbg.jpg'
changed_thumb = r'C:\Users\abdul\Desktop\tex\texture\ctn.png'
dev_background = r'C:\Users\abdul\Desktop\tex\defbg.jpg'
dev_thumb =r'C:\Users\abdul\Desktop\tex\defthum.png'
current_background_load = r'C:\Users\abdul\Desktop\tex\texture\defbg.jpg'
current_thumb_load = r'C:\Users\abdul\Desktop\tex\texture\defthum.png'



store_json = JsonStore(r'C:\Users\abdul\Desktop\tex\theme_json.json')

lessons= {}
_text_path = r'C:\Users\abdul\Desktop\tex\confi.txt'
...
####   load theme
#_theme_file_path = r'C:\Users\abdul\Desktop\tex\tar.txt'
...
# store_json.put('lessons_text_color',name =theme_load['lessons_text_color'])
# store_json.put('lessons_canvas_color',name =theme_load['lessons_canvas_color'])
# store_json.put('lessons_font_size',name =theme_load['lessons_font_size'])
# store_json.put('meet_link_canvas_color',name =theme_load['meet_link_canvas_color'])
# store_json.put('current_background',name =theme_load['current_background'])
# store_json.put('current_thumb',name =theme_load['current_thumb'])
...
################# files chooser ###########
    ...
    def cancel_new_image(self):
        self.ids.filetchooser.path = "/data/data/org.tesst.meettest5/tex"
        self.not_select_yet = True
